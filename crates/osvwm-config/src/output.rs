...
use knuffel::Decode;
use osv_ipc::{ConfiguredMode, HSyncPolarity, Transform, VSyncPolarity};
...
pub struct Modeline {
    ...
    pub hsync_polarity: osv_ipc::HSyncPolarity,
    /// Vertical sync polarity: "+vsync" or "-vsync".
    pub vsync_polarity: osv_ipc::VSyncPolarity,
}
...
impl OutputName {
    pub fn from_ipc_output(output: &osv_ipc::Output) -> Self {
        Self {
