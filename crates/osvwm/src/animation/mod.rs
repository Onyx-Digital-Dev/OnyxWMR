...
impl Animation {
    ...
    pub fn replace_config(&mut self, config: osvwm_config::Animation) {
        ...
        match config.kind {
            osvwm_config::animations::Kind::Spring(p) => {
            ...
            osvwm_config::animations::Kind::Easing(p) => {
                *self = Self::ease(
                    self.clock.clone(),
                    self.from,
                    self.to,
...
impl From<osvwm_config::animations::Curve> for Curve {
    fn from(value: osvwm_config::animations::Curve) -> Self {
        match value {
            osvwm_config::animations::Curve::Linear => Curve::Linear,
            osvwm_config::animations::Curve::EaseOutQuad => Curve::EaseOutQuad,
            osvwm_config::animations::Curve::EaseOutCubic => Curve::EaseOutCubic,
            osvwm_config::animations::Curve::EaseOutExpo => Curve::EaseOutExpo,
            osvwm_config::animations::Curve::CubicBezier(x1, y1, x2, y2) => {
