...
use osvwm_config::MruScope;

use crate::layout::workspace::WorkspaceId;
use crate::osvwm::{KeyboardFocus, Niri, State};
    ...
    pub fn start(&mut self) {
        ...
        self.event_loop
            .insert_source(rx, |e, _, state| match e {
                calloop::channel::Event::Msg(msg) => state.osvwm.on_a11y_msg(msg),
...
impl Osvwm {
    ...
    fn a11y_build_full_tree(&self) -> TreeUpdate {
        ...
        let tree = Tree {
            root: ID_ROOT,
            toolkit_name: Some(String::from("osvwm")),
