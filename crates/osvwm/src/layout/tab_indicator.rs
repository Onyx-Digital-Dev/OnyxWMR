...
use osvwm_config::{CornerRadius, Gradient, GradientRelativeTo, TabIndicatorPosition};
...
pub struct TabIndicator {
    ...
    config: osvwm_config::TabIndicator,
}
...
impl TabIndicator {
    pub fn new(config: osvwm_config::TabIndicator) -> Self {
        Self {
            shader_locs: Vec::new(),
            shaders: Vec::new(),
            open_anim: None,
    ...
    pub fn update_config(&mut self, config: osvwm_config::TabIndicator) {
        self.config = config;
    }
    ...
    pub fn start_open_animation(&mut self, clock: Clock, config: osvwm_config::Animation) {
    ...
    pub fn config(&self) -> osvwm_config::TabIndicator {
        self.config
    }
}
