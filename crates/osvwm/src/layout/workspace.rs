...
impl<W: LayoutElement> Workspace<W> {
    ...
    pub fn update_layout_config(&mut self, layout_config: Option<osvwm_config::LayoutPart>) {
...
fn compute_workspace_shadow_config(
    config: osvwm_config::WorkspaceShadow,
    view_size: Size<f64, Logical>,
) -> osvwm_config::Shadow {
    ...
    let mut config = osvwm_config::Shadow::from(config);
